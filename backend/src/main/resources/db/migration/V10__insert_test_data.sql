...
INSERT INTO products (name, description, price, image_url, stock_quantity, active, category_id, created_at) VALUES
                                                                                                                (
                                                                                                                    ...
                                                                                                                    20, true, (SELECT id FROM categories WHERE name='Kleidung' LIMIT 1), CURRENT_TIMESTAMP
    ),
(
    'Königliches Boubou',
    ...
    10, true, (SELECT id FROM categories WHERE name='Kleidung' LIMIT 1), CURRENT_TIMESTAMP
),
(
    'Kente Gold Tuch',
    ...
    5, true, (SELECT id FROM categories WHERE name='Stoffe' LIMIT 1), CURRENT_TIMESTAMP
)
