...
import de.nordbyte.mavazihub.auth.security.filter.CsrfValidationFilter;
    ...
    public SecurityFilterChain securityFilterChain(HttpSecurity http) throws Exception {
        http
                ...
                .authorizeHttpRequests(auth -> auth
                        ...
                        .requestMatchers("/api/admin/orders/**").hasAnyAuthority("ROLE_ADMIN", "ROLE_EMPLOYEE")
                        .requestMatchers("/api/admin/returns/**").hasAnyAuthority("ROLE_ADMIN", "ROLE_EMPLOYEE")
